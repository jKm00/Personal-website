...
<header class="header">
	...
	<a href="/" class="logo--tmp" on:click={() => (isOpen = !isOpen)}>jKm</a>
	<!-- Hamburger -->
	<div
		class="hamburger"
	...
	<nav class="nav" class:nav--open={isOpen}>
		...
		<div class="nav__footer">
			<ul class="nav__socials">
				<li class="nav__socials__item">
					<a class="nav__socials__link link" href="https://github.com/jKm00" aria-label="github"
				...
				<li class="nav__socials__item">
					<a class="nav__socials__link link" href="https://codepen.io/Jaakim" aria-label="codepen"
			...
			<p class="nav__footer__copy">Copyright &copy; 2022. All rights reserved</p>
		</div>
	</nav>
</header>
