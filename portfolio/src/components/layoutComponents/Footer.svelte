...
<footer class="footer section">
	<section class="footer__cta section">
		<div class="content">
			<h2 class="title title--primary">Still here ?</h2>
			<a href="mailto: joakimedvardsen2000@gmail.com" class="cta cta--dark">Take contact</a>
		</div>
	</section>
		...
		<div class="content">
			<ul class="footer__list">
				<li class="footer__list__item">
					<a sveltekit:prefetch class="footer__list__link" href="/"
				...
				<li class="footer__list__item">
					<a sveltekit:prefetch class="footer__list__link" href="/#about"
				...
				<li class="footer__list__item">
					<a sveltekit:prefetch class="footer__list__link" href="/#project"
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
							><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
				...
				<li class="footer__list__item">
					<a sveltekit:prefetch class="footer__list__link" href="/resume"
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"
							><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
			...
			<ul class="footer__list">
				<li class="footer__list__item">
					<a href="mailto: joakimedvardsen2000@gmail.com" class="footer__list__link"
				...
				<li class="footer__list__item">
					<a href="tel:901-59-363" class="footer__list__link"
				...
				<li class="footer__list__item">
					<a href="https://goo.gl/maps/e5LFTmGjxTodWSxz7" class="footer__list__link"
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"
							><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
				...
				<li class="footer__list__item">
					<a
						...
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
							...
							/></svg
						>linkedin.com/in/joakim-edvardsen</a
					>
				</li>
			</ul>
			<ul class="footer__socials">
				<li class="footer__socials__item">
					<a href="https://github.com/jKm00" aria-label="github" class="footer__socials__link"
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
							><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
				...
				<li class="footer__socials__item">
					<a href="https://codepen.io/Jaakim" aria-label="codepen" class="footer__socials__link"
						><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
							><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path
	...
	<section class="footer__legal section">
		<div class="content">
			<p>&copy; 2022 Joakim Edvardsen - All rights reserved</p>
		</div>
	</section>
</footer>
...
<style lang="scss">
	.footer {
		...
		&__cta {
			...
			min-height: calc(100vh - var(--linksHeight) - var(--legalHeight));
